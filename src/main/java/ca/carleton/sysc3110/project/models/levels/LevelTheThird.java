 ...
 */
public class LevelTheThird extends Level {

	/** The Constant serialVersionUID. */
	private static final long serialVersionUID = -7370924541340865199L;
	...
	public static final ZombieType[] WAVES = { ZombieType.WALKING_UNDEAD, ZombieType.RAPID_GHOUL,
			ZombieType.WALKING_UNDEAD, ZombieType.RAPID_GHOUL, ZombieType.LUMBERING_BRUTE, ZombieType.RAPID_GHOUL, ZombieType.RAPID_GHOUL, ZombieType.RAPID_GHOUL };
	
	/** The Constant WAVE_SPAWN. */
	public static final int[] WAVE_SPAWN = { 3, 2, 3, 1, 1, 3, 3, 3};

	/** The Constant WAVE_DELAY. */
	public static final int[] WAVE_DELAY = { 8, 3, 4, 3, 6, 1, 1, 1};
