 ...
 */
public class LevelTheFifth extends Level {

	/** The Constant serialVersionUID. */
	private static final long serialVersionUID = 5301315210305049701L;
	...
	public static final ZombieType[] WAVES = { ZombieType.WALKING_UNDEAD, ZombieType.RAPID_GHOUL,
			ZombieType.WALKING_UNDEAD, ZombieType.RAPID_GHOUL, ZombieType.LUMBERING_BRUTE, ZombieType.LUMBERING_BRUTE, ZombieType.LUMBERING_BRUTE , ZombieType.LUMBERING_BRUTE   };
	
	/** The Constant WAVE_SPAWN. */
	public static final int[] WAVE_SPAWN = { 3, 2, 3, 1, 1, 2, 3, 4};

	/** The Constant WAVE_DELAY. */
	public static final int[] WAVE_DELAY = { 8, 3, 4, 3, 6, 3, 3, 3};
	...
	public static final int INITIAL_SUN_POINTS = 200;
